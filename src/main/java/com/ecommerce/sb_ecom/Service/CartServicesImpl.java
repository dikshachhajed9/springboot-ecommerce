...
public class CartServicesImpl implements CartService{
    ...
    public List<CartDTO> getAllCarts() {
        ...
        if(carts.size()==0){
            throw new APIException("No cart exits");
        }
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if(cartItem==null){
            throw new APIException("Product"+product.getProductName()+"is not present in cart");
        }
    ...
    public void updateProductInCarts(Long cartId, Long productId) {
        ...
        if(cartItem==null){
            throw new APIException("Product"+product.getProductName()+"not avaliable in the cart");
